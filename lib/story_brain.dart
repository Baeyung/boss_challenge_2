...
class StoryBrain {
  ...
  void nextStory(int choice) {
    if (choice == 3 || choice == 4 || choice == 5) {
      restart();
    } else if (choice == 1 && _index == 0) {
      _index = 2;
    } else if (choice == 1 && _index == 2) {
      _index = 5;
    } else if (choice == 1 && _index == 1) {
      _index = 2;
    } else if (choice == 2 && _index == 0) {
      _index = 1;
    } else if (choice == 2 && _index == 1) {
      _index = 3;
    } else if (choice == 2 && _index == 2) {
      _index = 4;
    }
  }
